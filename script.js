  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!name || !email || !phone || !terms) {
        alert('אנא מלאו את כל השדות החובה ואשרו את תנאי השימוש');
        return;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מבקשי פניך משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '6c153ac0-f313-4a31-adfa-b1739589f35c',
                    name: data.name || '',
                    email: data.email || '',
